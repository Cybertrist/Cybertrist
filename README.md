...
<img src="docs/projets/cybersas.png" alt="CyberSas, réseau, en cours. Reverse proxy et VPN auto-hébergés : un point d'entrée unique, terminaison TLS, et un tunnel privé pour le reste" width="49.8%"><a href="https://github.com/Cybertrist/SmartBudget"><img src="docs/projets/smartbudget.png" alt="Smart Budget, finances, planifié. Arrêter de dépenser sans regarder, et de piocher dans l'épargne. Le mois entier sur un écran, et la part que prend chaque catégorie" width="49.8%"></a>
</p>
