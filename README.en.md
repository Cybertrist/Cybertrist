...
<img src="docs/en/projets/cybersas.png" alt="CyberSas, network, in progress. A self-hosted reverse proxy and VPN: a single way in, TLS terminated there, and a private tunnel for the rest" width="49.8%"><a href="https://github.com/Cybertrist/SmartBudget"><img src="docs/en/projets/smartbudget.png" alt="Smart Budget, finance, planned. Stop spending blind, and stop dipping into the savings. The whole month on one screen, and the share each category takes" width="49.8%"></a>
</p>
