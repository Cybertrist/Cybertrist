...
**When a constraint keeps coming back, I write the thing that makes it go away.** Most of the projects below started exactly like that: a budget melting away without me seeing it go, passwords scattered around with no vault to trust them to.
...
<a href="https://github.com/Cybertrist/CyberSas"><img src="docs/en/projets/cybersas-vpn.png" alt="CyberSas, VPN and Android, in progress. My own VPN, written end to end. A server that relays without reading, and the admin's fingerprint decides who gets in. Go, Noise IK, Ed25519, Flutter." width="100%"></a>
...
<a href="https://github.com/Microcoaster"><img src="docs/en/projets/microcoaster-carte.png" alt="MicroCoaster, web, embedded, coaster. A board designed from scratch, its firmware, and the web app that drives it. PCB design, ESP32, PlatformIO, WebSocket, Node.js, Socket.IO, MySQL, HTTPS." width="100%"></a>
